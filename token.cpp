...
std::ostream &operator<<(std::ostream &outs, const Token &tok)
{
    ...
    case Token::GREATER_THAN:
        outs << "TOKEN(GREATER_THAN)";
        break;
    case Token::GREATER_EQUAL:
        outs << "TOKEN(GREATER_EQUAL)";
        break;
    case Token::EQUAL:
        outs << "TOKEN(EQUAL)";
        break;
    case Token::LESS_THAN:
        outs << "TOKEN(LESS_THAN)";
        break;
    case Token::LESS_EQUAL:
        outs << "TOKEN(LESS_EQUAL)";
        break;
    case Token::VAL:
        outs << "TOKEN(VAL)";
        break;
    ...
    case Token::LEFT_BRACKETS:
        outs << "TOKEN(LEFT_BRACKETS)";
        break;
    case Token::RIGHT_BRACKETS:
        outs << "TOKEN(RIGHT_BRACKETS)";
        break;
    case Token::LINE_BREAK:
        outs << "TOKEN(LINE_BREAK)";
        break;
    case Token::DDOT:
        outs << "TOKEN(DDOT)";
        break;
